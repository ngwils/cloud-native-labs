            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user10') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user10/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user10') {
                    ...
                    openshift.tag("user10/gateway-canary:latest", "user10/gateway:latest")
